    ...
    <div className="min-h-screen flex" style={{ background: '#07070d' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12"
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-6 text-xs font-bold uppercase tracking-widest"
            ...
            <Sparkles className="w-3 h-3" /> AI-Powered Studying
          </div>
          ...
          <p className="text-white/40 text-base leading-relaxed max-w-sm">
            Your progress, goals and AI-generated flashcards are waiting for you.
          </p>
        </div>

        {/* Features list */}
        <div className="relative z-10 space-y-3">
          {['AI flashcards in seconds', 'Track your study streaks', 'Beat your academic goals'].map(f => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-black tracking-tight mb-2" style={{ fontFamily: 'Syne, sans-serif' }}>Sign in</h2>
            <p className="text-[#6e6e9a] text-sm">
              Don't have an account?{' '}
              <Link href="/auth/register" className="text-[#a78bfa] hover:text-[#c4b5fd] font-semibold transition-colors">
                Create one free
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <a href="#" className="text-xs text-[#6e6e9a] hover:text-[#a78bfa] transition-colors">Forgot password?</a>
              </div>
